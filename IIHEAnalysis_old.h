...
double FakeRate(double taupt) {
  double SF=1;
  if( taupt >= 30. && taupt < 40.)  { SF=0.452049;}
  else if( taupt >= 40. && taupt < 50.)  { SF=0.553117;}
  else if( taupt >= 50. && taupt < 60.)  { SF=0.505611;}
  else if( taupt >= 60. && taupt < 70.)  { SF=0.489362;}
  else if( taupt >= 70. && taupt < 80.)  { SF=0.462549;}
  else if( taupt >= 80. && taupt < 90.)  { SF=0.46281;}
  else if( taupt >= 90. && taupt < 100.)  { SF=0.41637;}
  else if( taupt >= 100. && taupt < 150.)  { SF=0.414793;}
  else if( taupt >= 150. && taupt < 250.)  { SF=0.398148;}
  else if( taupt >= 250. && taupt < 1000.)  { SF=0.40000;}
...
double GetCollinearMass(TLorentzVector tau, TLorentzVector mu,  TLorentzVector MET) {
  ...
  //now calculate the visible mass
...
double GetReweight_highmass(int PU, float mu_pt, float mu_eta, bool tau_match) {
  ...
  double tkLooseISO_sf_1 = Iso_histo_1->GetBinContent(bin_in); //Tight iso : < 0.15                                                                                                                                                                                       
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("outfile_191.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("outfile_191.root");
      }
...
void IIHEAnalysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_eta", &trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_eta, &b_trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_eta);
   fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_phi", &trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_phi, &b_trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_hltL1sSingleEG5ObjectMap_phi);
   ...
   fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_eta", &trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_eta, &b_trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_eta);
   fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_phi", &trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_phi, &b_trig_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_hltL1sSingleEG5ObjectMap_phi);
