...
hadd -f Arranged_data/dataB.root Out_Data_*16B*/*.root
hadd -f Arranged_data/dataC.root Out_Data_*16C*/*.root
hadd -f Arranged_data/dataD.root Out_Data_*16D*/*.root
hadd -f Arranged_data/dataE.root Out_Data_*16E*/*.root
hadd -f Arranged_data/dataF.root Out_Data_*16F*/*.root
hadd -f Arranged_data/dataG.root Out_Data_*16G*/*.root
hadd -f Arranged_data/dataH.root Out_Data_*16H*/*.root
hadd -f Arranged_data/data.root Arranged_data/dataB.root Arranged_data/dataC.root Arranged_data/dataD.root Arranged_data/dataE.root Arranged_data/dataF.root Arranged_data/dataG.root Arranged_data/dataH.root