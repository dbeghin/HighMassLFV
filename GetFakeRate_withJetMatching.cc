...
int main(/*int argc, char** argv*/) {
  ...
  vector<float> xpoints_up {0, 1000};                                             xpoints.push_back(xpoints_up);        sector_name.push_back("taupt_0_1000");
  ...
  vector<float> ypoints_lowleft {0, 30, 40, 50, 60, 70, 80, 100, 120};            ypoints.push_back(ypoints_lowleft);   sector_name[0] += "_jetpt_0_120";
  vector<float> ypoints_midleft {120, 300};                                       ypoints.push_back(ypoints_midleft);   sector_name[1] += "_jetpt_120_300";
  vector<float> ypoints_up {300, 1000};		              			  ypoints.push_back(ypoints_up);        sector_name[2] += "_jetpt_300_1000";
  vector<float> ypoints_lowright {0, 300};					  ypoints.push_back(ypoints_lowright);  sector_name[3] += "_jetpt_0_300";
