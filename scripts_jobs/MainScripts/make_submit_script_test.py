...
import os
from test_datasets import * #imports dataset paths: pnfn[], myname[] and myoption[] arrays 
if __name__ == "__main__":
    ...
    for jj in range(0, len(pnfn)):    
        ...
        command1 = command1 + "mkdir -p $workdir/TauID_test/Out_"+myname[jj] + "\n"      #Make output directories
        ...
        for i in f.readlines():   #f contains the root files in the /pnfs directory
            ...
            command2 = command2 + " \n"+ " mv  $scratchdir/Out" +str(ligne)+myname[jj]+ ".root \t" + "$workdir/TauID_test/Out_"+myname[jj]
            command2 = command2 + " \n\n\n"
