...
if __name__ == "__main__":
    ...
    region = "CR100"
    folder = "HighMassLFVMuTau/FakeRate_MtLow"
    ...
    for jj in range(0, len(pnfn)):    
        ...
        command3 = "qsub -q localgrid@cream02 -o " + "../out_err/"+myname[jj] +".stdout -e " +"../out_err/"+myname[jj] +".stderr -l walltime=11:16:00    " + "../Jobs_to_submit/"+name_out + "\n"  #Command to submit one job to the localgrid
        ...
        for i in f.readlines():   #f contains the root files in the /pnfs directory
            ...
            if ligne%files_per_job==0:   
                ...
                command1 = command1 + "cp /user/dbeghin/Work/MuTauHighMass/Reweighting/*.root Reweighting/" + "\n"
                outFile.write(command1)
                command3 = "qsub -q localgrid@cream02 -o "+ "../out_err/"+scr_name +".stdout -e " +"../out_err/"+scr_name +".stderr -l walltime=11:16:00    " + "../Jobs_to_submit/"+scr_name+".sh" + "\n"
                submit_File.write(command3)
