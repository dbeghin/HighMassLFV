...
if __name__ == "__main__":
    ...
    for jj in range(0, len(pnfn)):    
        ...
        command1 = command1 + "mkdir -p $workdir/TauIDsimple/Out_"+myname[jj] + "\n"      #Make output directories
        ...
        files_per_job = 2  #Set the number of root files per job
        for i in f.readlines():   #f contains the root files in the /pnfs directory
            ...
            command2 = "\n" + "./" + code_name + ".exe " + "$scratchdir/Out" +str(ligne)+myname[jj]+ ".root " +   i[0:-1] + " " + myoption[jj]
            command2 = command2 + " \n"+ " mv  $scratchdir/Out" +str(ligne)+myname[jj]+ ".root \t" + "$workdir/TauIDsimple/Out_"+myname[jj]
            command2 = command2 + " \n\n\n"
