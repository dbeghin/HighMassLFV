...
if __name__ == "__main__":
    ...
    for jj in range(0, len(pnfn)):    
        ...
        command1 = command1 + "mkdir -p $workdir/TauID_mumu/Out_"+myname[jj] + "\n"      #Make output directories
        ...
        for i in f.readlines():   #f contains the root files in the /pnfs directory
            ...
            command2 = "\n" + "./" + code_name + ".exe " + "$scratchdir/Out" +str(ligne)+myname[jj]+ ".root " +   i[0:-1] + " " + phase + myoption[jj]
            command2 = command2 + " \n"+ " mv  $scratchdir/Out" +str(ligne)+myname[jj]+ ".root \t" + "$workdir/TauID_mumu/Out_"+myname[jj]
            command2 = command2 + " \n\n\n"
